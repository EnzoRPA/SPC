...
<div class="flex h-screen bg-slate-100">
    ...
    <div class="w-64 bg-slate-900 text-white flex flex-col">
        <div class="p-4 text-xl font-bold text-blue-400 border-b border-slate-800">
            Admin Panel
        </div>
        <nav class="flex-1 p-4 space-y-2">
            <a href="index.php?page=admin&table=spc_inclusos" class="block px-4 py-2 rounded hover:bg-slate-800 <?php echo $table === 'spc_inclusos' ? 'bg-slate-800 text-blue-400' : ''; ?>">
                SPC Inclusos
            </a>
            <a href="index.php?page=admin&table=parcelas_em_aberto" class="block px-4 py-2 rounded hover:bg-slate-800 <?php echo $table === 'parcelas_em_aberto' ? 'bg-slate-800 text-blue-400' : ''; ?>">
                Parcelas em Aberto
            </a>
            <a href="index.php?page=admin&table=pdd_perdas" class="block px-4 py-2 rounded hover:bg-slate-800 <?php echo $table === 'pdd_perdas' ? 'bg-slate-800 text-blue-400' : ''; ?>">
                PDD Perdas
            </a>
            <a href="index.php?page=admin&table=pdd_pagos" class="block px-4 py-2 rounded hover:bg-slate-800 <?php echo $table === 'pdd_pagos' ? 'bg-slate-800 text-blue-400' : ''; ?>">
                PDD Pagos
            </a>
            <div class="border-t border-slate-800 my-2"></div>
            <a href="index.php?page=admin&table=import_batches" class="block px-4 py-2 rounded hover:bg-slate-800 <?php echo $table === 'import_batches' ? 'bg-slate-800 text-blue-400' : ''; ?>">
                Histórico de Importação
            </a>
            <a href="index.php?page=dashboard" class="block px-4 py-2 rounded hover:bg-slate-800 text-slate-400 mt-4">
                    ...
                    <tr class="hover:bg-slate-50">
                        <?php foreach ($row as $col => $val): ?>
                            <td class="px-3 py-2 whitespace-nowrap text-sm text-slate-500 max-w-xs truncate editable-cell" 
                                ...
                                <?php echo ($val !== null && $val !== '') ? htmlspecialchars($val) : '-'; ?>
                            </td>
                        <?php endforeach; ?>
